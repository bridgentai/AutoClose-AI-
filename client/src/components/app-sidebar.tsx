...
export function AppSidebar() {
  ...
  const menuItems = [
      ...
      // Mis Materias: Ahora solo para 'profesor' (Como lo tenías ajustado)
      { icon: BookOpen, label: 'Mis Materias', path: '/subjects', roles: ['profesor'] },

      // Calendario: Se quita 'estudiante' (Ahora va al Módulo 2: Comunidad)
      ...
      // MÓDULO 4: Mi Perfil (Reemplaza 'Mi Cuenta' y ajusta la ruta)
      // Se mantiene por ahora para todos, usando la nueva ruta modular /mi-perfil

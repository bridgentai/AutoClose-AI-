...
const navigationItems = [
  {
    ...
    path: "/nutricion/academia/consumo",
    icon: ClipboardList,
  },
  {
    title: "Pedidos por Estudiante",
    path: "/nutricion/academia/pedidos",
    icon: Users,
  },
  {
    title: "Reportes de Alimentación",
    path: "/nutricion/academia/reportes",
    icon: FileText,
  },
  {
    title: "Historial de Consumo",
    path: "/nutricion/academia/historial",
    icon: Calendar,
  },
];

export default function NutricionAcademiaLayout() {
  const { user } = useAuth();

...
import { ShoppingBag, Package, TrendingUp, Users, MessageSquare, Store } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card className="bg-white/5 border-white/10 backdrop-blur-md hover-elevate">
          ...
          <CardContent>
            ...
            <p className="text-sm text-white/50 mt-1">Disponibles</p>
          </CardContent>
        </Card>
        ...
        <Card className="bg-white/5 border-white/10 backdrop-blur-md hover-elevate">
          ...
          <CardContent>
            <div className="text-3xl font-bold text-white">0</div>
            <p className="text-sm text-white/50 mt-1">Items en stock</p>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-white/5 border-white/10 backdrop-blur-md">
          ...
          <CardContent className="space-y-3">
            ...
            <Button
              onClick={() => setLocation('/cafeteria/comunidad')}
              variant="outline"
            ...
            <Button
              onClick={() => setLocation('/cafeteria/academia')}
              variant="outline"
              className="w-full justify-start border-white/10 text-white hover:bg-white/10"
            >
        ...
        <Card className="bg-white/5 border-white/10 backdrop-blur-md">
          <CardHeader>
            <CardTitle className="text-white">Productos Populares</CardTitle>
            <CardDescription className="text-white/60">Más vendidos hoy</CardDescription>
          </CardHeader>
          <CardContent>

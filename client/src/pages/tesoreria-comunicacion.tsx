...
const navigationItems = [
  {
    ...
    path: "/tesoreria/comunicacion/bandeja",
    icon: Inbox,
  },
  {
    title: "Redactar Mensaje",
    path: "/tesoreria/comunicacion/redactar",
    icon: Send,
  },
  {
    title: "Mensajes Enviados",
    path: "/tesoreria/comunicacion/enviados",
    icon: Mail,
  },
  {
    title: "Recordatorios de Pago",
    path: "/tesoreria/comunicacion/recordatorios",
    icon: Bell,
  },
  {
    title: "Chat con Padres",
    path: "/tesoreria/comunicacion/padres",
    icon: MessageSquare,
  },
];

export default function TesoreriaComunicacionLayout() {
  const { user } = useAuth();
  ...
  return (
    <div className="p-6" data-testid="tesoreria-comunicacion-layout">
      <h1 className="text-2xl font-bold mb-6 text-white font-['Poppins']">
        Comunicación: Gestión de Pagos
      </h1>

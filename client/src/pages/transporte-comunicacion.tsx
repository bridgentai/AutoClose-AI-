...
const navigationItems = [
  {
    ...
    path: "/transporte/comunicacion/bandeja",
    icon: Inbox,
  },
  {
    title: "Redactar Mensaje",
    path: "/transporte/comunicacion/redactar",
    icon: Send,
  },
  {
    title: "Mensajes Enviados",
    path: "/transporte/comunicacion/enviados",
    icon: Mail,
  },
  {
    title: "Notificaciones de Llegada",
    path: "/transporte/comunicacion/llegadas",
    icon: Bell,
  },
  {
    title: "Chat con Padres",
    path: "/transporte/comunicacion/padres",
    icon: MessageSquare,
  },
];

export default function TransporteComunicacionLayout() {
  const { user } = useAuth();
  ...
  return (
    <div className="p-6" data-testid="transporte-comunicacion-layout">
      <h1 className="text-2xl font-bold mb-6 text-white font-['Poppins']">
        Comunicación: Notificaciones y Chats
      </h1>

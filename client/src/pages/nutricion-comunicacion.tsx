...
const navigationItems = [
  {
    ...
    path: "/nutricion/comunicacion/bandeja",
    icon: Inbox,
  },
  {
    title: "Redactar Mensaje",
    path: "/nutricion/comunicacion/redactar",
    icon: Send,
  },
  {
    title: "Mensajes Enviados",
    path: "/nutricion/comunicacion/enviados",
    icon: Mail,
  },
  {
    title: "Notificaciones de Alimentación",
    path: "/nutricion/comunicacion/notificaciones",
    icon: Bell,
  },
  {
    title: "Chat con Padres",
    path: "/nutricion/comunicacion/padres",
    icon: MessageSquare,
  },
];

export default function NutricionComunicacionLayout() {
  const { user } = useAuth();
  ...
  return (
    <div className="p-6" data-testid="nutricion-comunicacion-layout">
      <h1 className="text-2xl font-bold mb-6 text-white font-['Poppins']">
        Comunicación: Alimentación y Nutrición
      </h1>

    ...
    <div className="min-h-screen p-4 sm:p-6">
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <Card className={CARD_STYLE}>
          <CardHeader>
            <CardTitle className="text-white">Términos de uso de AutoClose AI</CardTitle>
          </CardHeader>
          <CardContent className="text-white/80 space-y-4 prose prose-invert max-w-none">
            ...
            <section>
              ...
              <p>
                Al utilizar la plataforma AutoClose AI usted acepta estos términos y condiciones.

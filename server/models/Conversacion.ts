...
interface IConversacion {
  ...
  tipo: 'colegio-padre' | 'profesor-padre' | 'directivo-padre' | 'asistente-padre';
...
const conversacionSchema = new Schema<IConversacion>({
  ...
  tipo: { type: String, required: true, enum: ['colegio-padre', 'profesor-padre', 'directivo-padre', 'asistente-padre'] },
